...
namespace transfer {
    ...
    public:
        ...
        /*!
         * \brief Коснтруктор с 2 параметрами, включающий регистрацию ошибок и информацию об отправке данных
        ...
        /*!
         * \brief Коснтруктор с 3 параметрами, включающий регистрацию ошибок и информацию об отправке данных
         * @param port - порт на котором будет построено соединение
         * @param way - путь, в который будут сохранены полученные объекты
